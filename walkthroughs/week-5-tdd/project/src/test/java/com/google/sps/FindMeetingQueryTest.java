...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeIsConsideredTwo() {
    // Have each person have different events, except for an optional attendee who
    // has an all day event. We should see two options because each required person
    // has split the restricted times. Ignore optional attendee
    //
    // Events  :       |--A--|     |--B--|
    //           |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  @Test
  public void everyAttendeeIsConsideredThree() {
    // Have two required attendees and one optional
    // whose meeting is exactly in between the two required
    // only return times completely available
    //
    // Events  :       |--A--|     |--B--|
    //                       |--C--|
    // Day     : |-----------------------------|
  ...
  @Test
  public void justEnoughRoomTwo() {
    // Have one required person, and one optional person, but make it so that 
    // optional person is ignored because considering them would result in time
    // slot smaller than requested time 
    //
    // Events  : |--A--|
    //                 |-B-||--A-------|
    // Day     : |---------------------|
  ...
  @Test
  public void optionalRoom() {
    // Have just two optional attendees with gaps in their days
    //
    // Events  :    |-A-|  |-B-|
    // Day     : |---------------------|
    // Options : |-1|   |-2|   |---3---|
